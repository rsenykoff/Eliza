...
public class ElizaRespLdr implements Runnable{
    ...
    */
    public void run(){
        ...
        cq[0].loadresponse("Perhaps in your imagination...");
        cq[0].loadresponse("I have a headache today. Tomorrow perhaps...");
        ...
        cq[6].loadkeyword("machine");
        cq[6].loadkeyword("machines");
        ...
        cq[27].loadresponse("What a great day at HarrisLOGIC.");
